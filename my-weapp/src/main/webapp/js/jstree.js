/*New Code globals jQuery, define, exports, require, window, document, postMessage */
(function (factory) {
	"use strict";
		...
		bind : function () {
			...
			this.element
				...
				.on("click.jstree", ".jstree-anchor", $.proxy(function (e) {
						...
						/*clickOnTree(this._data.core.last_clicked.original)*/
					}, this))
	...
	$.jstree.plugins.search = function (options, parent) {
		...
		this.search = function (str, skip_async, show_only_matches, inside, append) {
			...
			var s = this.settings.search,
				...
				r = [],
				p = [], i, j;
			if(this._data.search.res.length && !append && !multiWord) {
				this.clear_search();
			}
