			...
			<div class="container-fluid content-wrapper">
								...
								<c:forEach var="shipmentVO" items="${shipmentVOs}"
									...
									<td><c:if
											...
											<c:if test="${not empty shipmentVO.trackingReference}">
												<a href="${shipmentVO.carrierTrackingURL}" target="_blank">${shipmentVO.trackingReference}</a>
											</c:if>
					...
					<div class="">
						<div
							...
							<div id="cart-items-hldr"
								...
								<div
									class="col-lg-12 col-md-12 col-sm-12 col-xs-12 search-parts-template cart-details">
								...
								<div class="clearfix">
									...
									<c:if test="${properties['file.attachment.required']==true}">
										<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
											...
											<a href="javascript:void(0);" class="inline"
												id="attachedFile"></a>
                ...
                <div class="section" id = "SALES_REP_SECTION1">
					...
					<div class="quote-total">
						...
						<div
							class="col-lg-12 col-md-12 col-sm-12 col-xs-12 column-paddings">
							<a href="getorders" class="pull-right blue-button"><spring:message
    ...
    var valueHideOrShow; 
     $(document).ready(function(e){
	    ...
	    //alert("json.chargeList :"+json.chargeList.length);
 	  	...
 	  	if(typeof myjson.orderedBy!="undefined"){
  		var salesRep = myjson.orderedBy.userId + " - " + myjson.orderedBy.firstName + " " + myjson.orderedBy.lastName;
	    ...
	    /*Commented to not to show attachment removed comment on file attachment */
