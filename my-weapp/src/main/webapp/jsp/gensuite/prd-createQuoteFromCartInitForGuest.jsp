					...
					<div class="section">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div
								...
								<label for="customer-no" class="labelleftalign control-label column-paddings required"><spring:message
										code="label.quote.order.customer" /></label>
								<div class="input-group col-lg-8 col-md-8 col-sm-8 col-xs-12"
									data-input-width="width">
									<input type="text"
										class="form-control customerNoInput spaceLeft10x"
										name="customerName" />
								...
								<a class="tooltip_mobile tooltip_tabber help-button" data-placement="left"
									...
									data-original-title="<spring:message code="label.quote.customer.message" />"
									>?</a>
							</div>
							<div class="form-inline">
								<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 column-paddings">
									<label for="reference-no" class="labelleftalign control-label column-paddings"><spring:message
											...
											<%-- <a class="help-button visible-xs pull-right" href="javascript:;"
									...
									<input type="text" id="reference-no"
										...
										maxlength="100" /> 										
										<a class="tooltip_mobile tooltip_tabber help-button"
							...
							<div
								class="col-lg-5 col-md-9 col-sm-9 col-xs-12 column-paddings other_fileds">
								<div
									...
									<sec:authorize
										...
										<label
											class="labelleftalign control-label col-lg-6 col-md-4 col-sm-4 col-xs-12 charges-label nopadding-xs required" id="carrierBillingOptionLable"><spring:message
							...
							<div
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column-paddingsx">
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div
							...
							<h5
								class="col-lg-2 col-md-2 col-sm-2 col-xs-4 text-right"
								id="subTotal"></h5>
							</sec:authorize>
							<sec:authorize access="!hasRole('ROLE_PRICE')">
							<h5
			...
			<div class="modal bs-example-modal-md" id="backButtonConfirmationWindow" data-backdrop="static" data-keyboard="false">
				<div class="modal-dialog">
					<div class="modal-content custom-modal-content">
						...
						<div class="modal-footer">
							<a class="col btn cancel" id="backButtonCancel" 
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
	    	...
	    	/* if(userApplication == "REVFIRE"){
        	 ...
        	 handleTransportMode();
            //$(".close").text("x");
        	// for stoping form submission on click of enter 
           ...
           /* 
            ...
            /* $(".next.review-quote").on("click", function () {
			...
			var selectObj = jQuery.parseJSON(stateList);
			$.each(selectObj, function(index, itemData) {
				   var option = $('<option/>');
				   var country = itemData.countryReference;
					option.attr({ 'value': itemData.stateId,'data-countryName': itemData.countryReference,'data-stateId': itemData.stateId  }).text(itemData.stateName+"-"+itemData.stateReference);
					
					$('#shipToStateSelect').append(option);
					//$('#billToStateSelect').append(option);
			...
			$('#shipToAddressCountry').attr('readonly','readonly');
			$('#billToAddressCountry').attr('readonly','readonly');
	 		*/
	 		//Venkatasiva End
			/* console.log("dfajl;a"+$("#shipToStateSelect").find("option"));
		 	var stateReference = "-"+quoteJson["shipToAddress"].addressState;
		 	var stateId = $("#shipToStateSelect").find("option:contains('"+stateReference+"')").val();
           ...
           /*  if(!quoteJson.billToOverriddenAllow){
			...
			//Added by Krupa for Breadcrumbs Issue on 20-Oct-2015
	       	 var previousURL = '${previousURL}';
			        ...
			        var isFromCart="";
			        var cartLink="";
			        var breadcrumbArray = '${breadcrumbsArray}';
                ...
                open:function(event) {
                    ...
                    if(width >= 1025){
                      $('.ui-autocomplete').css({'width': 243 + 'px','max-height': 150 + 'px'});  
                        ...
                        $('.ui-autocomplete').css({'width': 454 + 'px','max-height': 150 + 'px'});  
                    }
                },
	      ...
	      $('.attach-file-section > label').tooltip({'trigger':'hover','placement':'right','title':'<spring:message code="tooltip.quote.filesize" javaScriptEscape="true"/>'});
            ...
            //alert(quoteJson.newContactExist);
            if(isFromCartBrand=="false" && typeof quoteJson.billToAddress.addressName!="undefined"){
				...
				$("#billToStateSelect").val(quoteJson.billToAddress.addressState);
     	   	 ...
     	   	 if(isFromCartBrand=="false" && typeof quoteJson["shipToAddress"].addressName!="undefined"){
		   		...
		   		$(".customerNoInput").val(quoteJson.customerName);
     	   	 }
	          ...
	          success : function(response) {
	        	  var locale=${locale};
                    ...
                    if(response.cartItem.itemTotalMSRPStr != "-1"){
                        ...
                        $(".cartItemTotal[data-cartItem='"+response.cartItem.partId+"']").parents('.div-part').find('input.alertFlagInput').val(response.cartItem.itemTotalMSRPStr);
                        checkAlertMessage();
                    }else{
                        $(".cartItemTotal[data-cartItem='"+response.cartItem.partId+"']").html(" - ");
                        $(".cartItemTotal[data-cartItem='"+response.cartItem.partId+"']").parents('.div-part').find('input.alertFlagInput').val("-1");
...
/* 	 function validateKey(e) {
	...
	function formValidation(){
		var customer = $('.customerNoInput').val();
		...
		else if($('#billToAddressZipCode').val()==""){
		...
		else if($('#shipToAddressZipCode').val()==""){
