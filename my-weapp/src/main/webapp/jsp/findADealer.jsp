			...
			<div class="breadcrumbs-list fixed responsive-padding">
				<ul class="breadcrumb">
					...
					<li class="active"><spring:message
							code="label.header.findADealer" /></li>
				</ul>
			</div>
			<!-- content wrapper for the current page contents -->
			<!--NREV-1530 Worked by Pushpa Reviewed by JK -->
			<div>&nbsp;</div>
			<div>

				<iframe id='bullseye_iframe'
					src="${properties['findADealer.iframe.url']}" width='100%'
					height='1555px' border='0' style='border: none; padding-left: 15px;' scrolling='auto'
					onload='window.parent.scrollTo(0,0);' allow='geolocation'></iframe>
			</div>
			<!--End NREV-1530-->
			<!-- content wrapper for the current page contents ends -->
			<!-- footer container -->
			<footer>
	...
	<script type="text/javascript">
		...
		var bullseyelistener = function(e) {
			...
			if (regex.test(e.origin) && Number.isInteger(e.data)) {
				document.getElementById('bullseye_iframe').height = Math
						.round(e.data);
			}
		}
